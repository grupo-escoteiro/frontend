...
function Ramos() {
  ...
  return (
    <section>
      <div className="max-w-[1160px] mx-auto">
        ...
        <div className="flex margin-auto gap-x-32">
          <img
            ...
            src={lobinho} />
          <p className='text-2xl'><p><span className='text-social-brand '>Lobinho:</span></p>
            ...
            <button onClick={handleModalOpenLobinho} className="text-social-brand flex py-10 " type="button" >
              Ver mais
            </button>
          </p>
        </div>
        <div className="flex margin-auto pt-44 gap-x-28 mb-20">
          <p className=' text-2xl'><p><span className='text-social-brand '>Junior:</span></p>
      ...
      <Modal open={openLobinho} onClose={handleModalOpenLobinho}>

        <h2 className="text-xl font-bold">Lobinho</h2>
        <p> O Lobismo é parte do movimento educacional escoteiro desenvolvido para aplicar os Princípios do Escotismo,
          de
          Conta com a colaboração de adultos voluntários,
          segundo os Fundamentos do Escotismo,
          ...
          além de propiciar o conhecer e respeitar o próximo,
          procurando desenvolver o senso de cooperação, participação e o convívio harmonioso com a comunidade.
          tratando de forma indissociável dos demais pilares, abaixo descritos,
          o escoteiro é estimulado a procurar em Deus seu referencial, praticando sua crença e respeitando os demais.
          transcendendo o dever de sua comunidade o escoteiro é estimulado através do seu conhecimento cívico e social,
          a compreender, aprimorar e multiplicar os valores do cidadão Brasileiro.
          estimulando atividades as quais se compreendem o valor do próximo,
          o escoteiro baseia todo o seu trabalho ao servir ao próximo e cuidar de seu bem-estar.
          É vivenciando as experiências que o jovem aprende, desenvolve e inova seu mundo.
          É aprendendo pela prática que ele vai aprimorando seus conhecimentos.</p>
        <button onClick={handleModalOpenLobinho} className="mt-4 text-social-brand">
          Fechar Modal
        </button>
      ...
      {/* Modal Junior */}
      <Modal open={openJunior} onClose={handleModalOpenJunior}>

        <h2 className="text-xl font-bold">Modal Junior</h2>
        <p>A Seção Júnior visa proporcionar ao pré-adolescente e o
          adolescente de ambos os sexos o incentivo no desenvolvimento do caráter,
          respeitando as transformações do corpo e da mente e trabalhando para um pleno,
          desenvolvimento físico, intelectual, afetivo e espiritual.
          Levando esse adolescente a buscar com afinco o conhecimento.
          Os escoteiros juniores são estimulados a descobrir seus limites em atividades como acampamentos,
          jornadas e jogos ao ar livre.
          A organização e as atividades dos juniores se encontram neste documento,
          nos Livros de Baden-Powell, Scouting for boys,
          e Guide of Scoutmastere nos guias específicos do Ramo Júnior.
          ...
          O Escoteiro é Amigo de todos e Irmão dos demais Escoteiros;</p>
        <button onClick={handleModalOpenJunior} className="mt-4 text-social-brand">
          Fechar Modal
        </button>
