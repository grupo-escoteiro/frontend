    ...
    <PageTransition>
      <Container className="grid grid-cols-[1fr_3fr] gap-x-7 w-[1160px]">
        ...
        <div className="py-16 px-8 gap-y-8 flex flex-col items-center">
          ...
          />
          <form>
            <fieldset className="grid grid-cols-2 gap-x-6 gap-y-6 pb-12">
              <div className="flex flex-col gap-y-2">
                ...
                <input 
                  ...
                  className="w-80 h-16 px-5 py-5 rounded border border-social-gray"
                />
              </div>
              <div className="flex flex-col gap-y-2">
                <label 
            ...
            <fieldset className="flex justify-end items-center gap-x-6">
              <Link
                to="/"
