...
const navItems = [
  ...
  { text: 'Login', to: '/autenticacao/login' },
];
    ...
    <aside>
      <div
        className={`sidebar fixed top-0 bottom-0 right-0 p-2 w-2/3 text-center bg-light-social-brand 
                    z-10 transition-transform duration-500 flex flex-col
      ...
      <button
        className="fixed left-4 top-16 z-20 cursor-pointer transition-all ease-in-out duration-200
